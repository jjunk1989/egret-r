...
export let EXML: any = {};
     ...
     * of a class through <code>getDefinitionByName(className)</code>.
     *
     * @param text the text of a EXML file.
     *
     * @version Egret 2.4
     ...
     * 若指定的类名已经存在，将会注册失败，并输出一个警告。注册成功后，您也可以通过 getDefinitionByName(className) 方法获取这个 EXML 文件对应的类定义。
     *
