...
export const coreCases = [
    ...
    },
    {
        ...
        run: ({ root, stage }) => {
            ...
            fpsLabel.y = 134;
            fpsLabel.size = 22;
            fpsLabel.textColor = 0x2563eb;
            fpsLabel.text = 'FPS: --';
            root.addChild(fpsLabel);
            objects.push(fpsLabel);
            // Detail line
