...
function resolveInitialCaseId() {
    const fromWindow = window.__EGRET_TEST_CASE__;
...
class Main extends egret.DisplayObjectContainer {
    ...
    onAddedToStage() {
        ...
        window.addEventListener(TEST_CHANGE_EVENT, this.onCaseChange);
    ...
    applyCase(id) {
        ...
        const maybeCleanup = current.run({ root: this.sceneRoot, stage: this.stage });
    ...
    $onRemoveFromStage() {
        ...
        window.removeEventListener(TEST_CHANGE_EVENT, this.onCaseChange);
